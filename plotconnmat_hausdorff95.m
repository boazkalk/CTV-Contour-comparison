function plotconnmat_hausdorff95(specialists, nr_patients, nr_specialists, Result_hdistD95_intramod)
    ...
    tempres35 = Result_hdistD95_intramod(patient).mod(1).D95;
    tempres15 = Result_hdistD95_intramod(patient).mod(2).D95;
    ...
    sgtitle(strcat('Intra modality hausdorff 95th percentile, Patient = ', num2str(patient)));
    ...
    for j = 1:1:nr_patients
        mean_dice_intramod(1).dice = mean_dice_intramod(1).dice + Result_hdistD95_intramod(j).mod(1).D95;
        mean_dice_intramod(2).dice = mean_dice_intramod(2).dice + Result_hdistD95_intramod(j).mod(2).D95;
    end
    ...
    sgtitle(strcat('Intra modality hausdorff 95th percentile meaned for all patients'));
